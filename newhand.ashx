<%@ WebHandler Language="C#" Class="newhand" %>
...
public class newhand : IHttpHandler
{
    ...
    public void ProcessRequest(HttpContext context)
    {
        ...
        insertquery = "select imgpath from filedet where uname='" + imageid + "'";
